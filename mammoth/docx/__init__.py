...
def read(fileobj, external_file_access=False, track_changes=False, add_page_breaks=False):
...
def _part_with_body_reader(document_path, zip_file, part_paths, external_file_access, track_changes, add_page_breaks):
